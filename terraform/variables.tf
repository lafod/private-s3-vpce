...
variable "deploy_api" {
  type        = bool
  default     = true
  description = "Deploys an API with a Lambda target that generates a pre-signed URL for an object in the bucket. Will be integrated in the ALB in /api/* routes."
}
